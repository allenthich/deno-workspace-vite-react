...
import type { GetPetByIdQueryResponse, GetPetByIdPathParams, GetPetById400, GetPetById404 } from "../types/GetPetById.ts";
 ...
 * @link /pet/:petId
 */
export function useGetPetByIdSuspense<TData = GetPetByIdQueryResponse, TQueryData = GetPetByIdQueryResponse, TQueryKey extends QueryKey = GetPetByIdSuspenseQueryKey>(petId: GetPetByIdPathParams["petId"], options: {
