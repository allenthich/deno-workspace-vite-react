...
import type { LoginUserQueryResponse, LoginUserQueryParams, LoginUser400 } from "../types/LoginUser.ts";
...
async function loginUser(params?: LoginUserQueryParams, config: Partial<RequestConfig> = {}) {
    const res = await client<LoginUserQueryResponse, LoginUser400, unknown>({ method: "GET", url: `/user/login`, baseURL: "https://petstore3.swagger.io/api/v3", params, ...config });
    return res.data;
}
 ...
 * @link /user/login
 */
export function useLoginUserSuspense<TData = LoginUserQueryResponse, TQueryData = LoginUserQueryResponse, TQueryKey extends QueryKey = LoginUserSuspenseQueryKey>(params?: LoginUserQueryParams, options: {
