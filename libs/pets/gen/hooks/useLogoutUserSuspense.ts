 ...
 * @link /user/logout
 */
export function useLogoutUserSuspense<TData = LogoutUserQueryResponse, TQueryData = LogoutUserQueryResponse, TQueryKey extends QueryKey = LogoutUserSuspenseQueryKey>(options: {
