...
import type { UploadFileMutationRequest, UploadFileMutationResponse, UploadFilePathParams, UploadFileQueryParams } from "../types/UploadFile.ts";
...
export function useUploadFile(options: {
    mutation?: UseMutationOptions<UploadFileMutationResponse, Error, {
