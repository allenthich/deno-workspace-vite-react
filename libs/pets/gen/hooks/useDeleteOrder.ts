...
import type { DeleteOrderMutationResponse, DeleteOrderPathParams, DeleteOrder400, DeleteOrder404 } from "../types/DeleteOrder.ts";
...
export function useDeleteOrder(options: {
    mutation?: UseMutationOptions<DeleteOrderMutationResponse, DeleteOrder400 | DeleteOrder404, {
    ...
    return useMutation<DeleteOrderMutationResponse, DeleteOrder400 | DeleteOrder404, {
        orderId: DeleteOrderPathParams["orderId"];
    }>({
